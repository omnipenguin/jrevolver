      ...
      switch (propData) {
        ...
        case INCLUDE_TYPE.PERMUTE: {
          ...
          for (const _mapProp of jsonMaps) {
            ...
            if (
              hasSomeProperty(baseJson, [ baseProp, mapProp, JR_MAP_FUNCTIONS.mapAllowOnly, JR_MAP_FUNCTIONS.mapExclude ]) ||
              hasSomeProperty(overrideJson, [ baseProp, mapProp, JR_MAP_FUNCTIONS.mapAllowOnly, JR_MAP_FUNCTIONS.mapExclude ])
            ) {
