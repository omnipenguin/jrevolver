...
/**
 * Parses a string and returns a map function name if the string invokes a jRevolver function
 * @param {String} key - String property to check
 * @param {Array|String} [mapFunctions] - map functions that should pass validation
 */
...
/**
 * Parses a string and returns a map key name if the string invokes a jRevolver function
 * @param {String} key - String property to check
 * @param {Array|String} [mapFunctions] - map functions that should pass validation
 */
